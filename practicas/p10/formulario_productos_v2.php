...
<body>
    ...
    <form id="formulario" action="http://localhost/TecWeb/practicas/p09/set_producto_v2.php" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <input type="hidden" name="id" id="form-id" value="<?= isset($_GET['id']) ? $_GET['id'] : '' ?>">
            ...
            <textarea name="detalles_producto" rows="4" cols="60" id="form-detalles" placeholder="No más de 250 caracteres de longitud"><?= isset($_GET['detalles']) ? $_GET['detalles'] : '' ?></textarea><br>
            ...
            <label for="form-imagen">Imagen del Producto (URL): </label> 
            <input type="text" name="imagen_producto" id="form-imagen" value="<?= isset($_GET['imagen']) ? $_GET['imagen'] : '' ?>">
        </fieldset>
        <p>
            <input type="submit" value="Actualizar" onclick="return validarProductos()">
